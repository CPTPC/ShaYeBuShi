...
public class WaterMoveTimedKillUnit extends UnitWaterMove implements WaterMovec,Boundedc, Builderc, Drawc, Entityc, Flyingc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, TimedKillc, Unitc, Velc, Weaponsc {
    ...
    protected WaterMoveTimedKillUnit() {
    }
    ...
    public void read(Reads read) {
        ...
        if(REV == 0) {
            ...
            throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'missile'");
        }
    ...
    public float floorSpeedMultiplier() {
        ...
        Floor on = isFlying() || hovering || type.naval ? Blocks.air.asFloor() : floorOn();
    ...
    public static WaterMoveTimedKillUnit create() {
        return new WaterMoveTimedKillUnit();
    }
    public void add() {
    ...
    public void destroy() {
        ...
        for (WeaponMount mount : mounts) {
//            System.out.println(mount.weapon.shootOnDeath && !(
//                    mount.weapon.bullet.killShooter &&
//                            mount.totalShots > 0));
            if (mount.weapon.shootOnDeath && !(
                    mount.weapon.bullet.killShooter &&
                            mount.totalShots > 0)) {
                mount.reload = 0.0F;
                mount.shoot = true;
                mount.weapon.update(this, mount);
//                mount.weapon.shoot(this,mount,x,y,x,y) ;
            }
        }
