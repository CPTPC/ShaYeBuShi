...
import shayebushi.world.SYBSBuild;

import static mindustry.Vars.tilesize;
import static mindustry.Vars.world;

public class SYBSBuildPlan extends BuildPlan implements Position , QuadTree.QuadTreeObject {
    ...
    public SYBSBuildPlan(int x, int y, int rotation, Block block){
        this.x = x;
        this.y = y;
    ...
    public SYBSBuildPlan(int x, int y, int rotation, Block block, Object config){
        this.x = x;
        this.y = y;
        if(block != null) this.rotation = block.planRotation(rotation);
        this.block = block;
    ...
    public SYBSBuildPlan(int x, int y){
        this.x = x;
        this.y = y;
        this.rotation = -1;
    ...
    public SYBSBuildPlan(){

    }

    public boolean placeable(Team team){
        return SYBSBuild.validPlace(block, team, x, y, rotation);
    }
