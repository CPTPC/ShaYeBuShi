...
public class TeShuBasicBulletType extends TeShuBulletType{
    ...
    public TeShuBasicBulletType(float speed, float damage, String bulletSprite){
        super(speed, damage);
        this.sprite = bulletSprite;
    }

    public TeShuBasicBulletType(float speed, float damage){
        this(speed, damage, "bullet");
    }

    /** For mods. */
    public TeShuBasicBulletType(){
        this(1f, 1f, "bullet");
    }
