...
public class HuoYanBulletType extends BulletType implements WuShiXianShangc {
    public Color[] colors = {Pal.lightFlame, Pal.darkFlame, Color.gray};
    public Color[] smokeColors = {};
    public float particleSpread = 8f, particleSizeScl = 11f;
    public int particleAmount = 23;
    public final Color tc = new Color(), tc2 = new Color();
    public Color[] hitColors;
    public Boolf<Bullet> can = b -> false ;

    public HuoYanBulletType(float speed, float damage){
        super(speed, damage);
        pierce = true;
        pierceArmor = true ;
        lifetime = 12f;
