...
public class HaoJieChongShengAbility extends Ability {
    ...
    public HaoJieChongShengAbility(UnitType unit, int amount, float spread, UnitType unitt){
        this.unit = unit;
        this.unit = SYBSShenShengUnitTypes.haojieyijieduan;
        this.amount = amount;
        this.spread = spread;
        this.unitt = unitt;
        this.unitt = SYBSShenShengUnitTypes.haojieerjieduan ;
    }

    public HaoJieChongShengAbility(){
        this.unit = SYBSShenShengUnitTypes.haojieyijieduan;
        this.amount = 1;
        this.spread = 0;
        this.unitt = SYBSShenShengUnitTypes.haojieerjieduan ;
