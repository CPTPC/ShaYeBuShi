...
public class SYBSEntityGroup<T extends Entityc> extends EntityGroup<T> {
    ...
    public SYBSEntityGroup(Class<T> type, boolean spatial, boolean mapping){
        this(type, spatial, mapping, null);
    }

    public SYBSEntityGroup(Class<T> type, boolean spatial, boolean mapping, EntityIndexer indexer){
        super(type, spatial, mapping, indexer) ;
