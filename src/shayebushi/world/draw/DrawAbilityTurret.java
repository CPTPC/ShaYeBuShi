...
public class DrawAbilityTurret extends DrawTurret {
    ...
    public DrawAbilityTurret(String basePrefix){
        this.basePrefix = basePrefix;
    }

    public DrawAbilityTurret(){
    }
    ...
    public void draw(Building build){
        AbilityTurret turret = (AbilityTurret)build.block;
        AbilityTurret.AbilityTurretBuild tb = (AbilityTurret.AbilityTurretBuild)build;
    ...
    public void drawTurret(AbilityTurret block, AbilityTurret.AbilityTurretBuild build){
    ...
    public void drawHeat(AbilityTurret block, AbilityTurret.AbilityTurretBuild build){
    ...
    public void load(Block block){
        if(!(block instanceof AbilityTurret)) throw new ClassCastException("This drawer can only be used on turrets.");
