...
public class TurretMoYan extends mindustry.world.blocks.defense.turrets.PowerTurret {
    //after being logic-controlled and this amount of time passes, the turret will resume normal AI
    public final static float logicControlCooldown = 60 * 2;
    public float rotPerSecond = 3 ;
    public boolean alwaysRot = false ;
    public boolean rotWhenShooting = true ;
    ...
    public TurretMoYan(String name){
        super(name);
        liquidCapacity = 20f;
        quickRotate = false;
        outlinedIcon = 1;
    ...
    public class TurretMoYanBuild extends PowerTurretBuild implements ControlBlock {
...
//                    }
                    ...
                    if(!alwaysShooting
                            //&& Angles.angleDist(rotation, targetRot) < shootCone
                            && canShoot){
                        wasShooting = true;
                        updateShooting();
                    }
        ...
        protected void updateShooting(){
            ...
            if(reloadCounter >= reload && !charging() && shootWarmup >= minWarmup) {
                ...
                for (Consume c : consumeBuilder){
                    if (c instanceof ConsumeItems cc){
                        items.remove(cc.items);
                    }
                }
