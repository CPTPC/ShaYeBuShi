...
public class TurretCeFan extends ItemTurret {
    public ObjectMap<Item, BulletType> ammoTypes = new OrderedMap<>();
    public static arc.graphics.Color color ;
    public TurretCeFan(String name){
        super(name);
        hasItems = true;
    }
    ...
    public class TurreCeFanBuild extends ItemTurretBuild {
        public void I(Color colorr){
            color = colorr ;
        }
        @Override
