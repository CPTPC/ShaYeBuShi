...
public class PowerTurretXianZhi extends TurretXianZhi{
    public BulletType shootType;

    public PowerTurretXianZhi(String name){
        super(name);
        hasPower = true;
    }
    ...
    public class PowerTurretXianZhiBuild extends TurretXianZhiBuild{
