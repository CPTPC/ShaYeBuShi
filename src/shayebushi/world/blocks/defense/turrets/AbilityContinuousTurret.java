...
public class AbilityContinuousTurret extends AbilityTurret {
    ...
    public AbilityContinuousTurret(String name){
        super(name);
    ...
    public class AbilityContinuousTurretBuild extends AbilityTurretBuild {
