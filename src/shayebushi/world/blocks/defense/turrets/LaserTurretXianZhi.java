...
public class LaserTurretXianZhi extends PowerTurretXianZhi {
    public float firingMoveFract = 0.25f;
    public float shootDuration = 100f;

    public LaserTurretXianZhi(String name){
        super(name);
    ...
    public class LaserTurretXianZhiBuild extends PowerTurretXianZhiBuild{
