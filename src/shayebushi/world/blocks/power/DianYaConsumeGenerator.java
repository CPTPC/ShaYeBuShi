...
public class DianYaConsumeGenerator extends DianYaGenerator {
    ...
    public DianYaConsumeGenerator(String name){
        super(name);
    }
    ...
    public class DianYaConsumeGeneratorBuild extends DianYaGeneratorBuild {
